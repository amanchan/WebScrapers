...
br.form['coll_start'] = '1'
#br.form['CollectionStartIndex'] = '1'
control1 = br.form.find_control('EntrezSystem2.PEntrez.clinVar.clinVar_Entrez_ResultsPanel.Entrez_Pager.cPage', nr=0)
control2 = br.form.find_control('EntrezSystem2.PEntrez.clinVar.clinVar_Entrez_ResultsPanel.Entrez_Pager.cPage', nr=1)
control1.value = '1'
control2.value = '1'
#br.form['EntrezSystem2.PEntrez.clinVar.clinVar_Entrez_ResultsPanel.Entrez_Pager.cPage'] = '1'
#br.form['EntrezSystem2.PEntrez.clinVar.clinVar_Entrez_ResultsPanel.Entrez_Pager.CurrPage'] = '2'
#br.form['EntrezSystem2.PEntrez.clinVar.clinVar_Entrez_ResultsPanel.Entrez_Pager.cPage'] = '1'
br.submit()
response= br.response()
html = br.response().read()
